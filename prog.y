...
%token IF ELSE FOR CONTINUE BREAK RETURN READ DO WHILE ENDL DOBLEMAS
...
out_stmt
  ...
  | COUT SHL_OP IDENTIFIER SHL_OP ENDL ';' { $$ = out_stmt_new($3,NULL); }
  | COUT SHL_OP CONSTANT_STRING SHL_OP ENDL ';' { $$ = out_stmt_new(0,$3); }
  ;
